...
NOCODB_BASE_URL = "https://nocodb-s9q9e-u27285.vm.elestio.app"
NOCODB_API_TOKEN = "wlf8BFp6fkR-NNoL9TZQ91sJ8msFwB_kWhXqPyTZ"  # Better to load from environment variables
...
class NocoDBClient:
    ...
    def create_job(self, user_id: int, internal_id: str, 
        ...
        url = f"{self.base_url}/api/v2/tables/{TABLE_JOB}/records"
        payload = {
            "user_id": user_id,
...
class AnymizeOCRProcessor:
    ...
    def __init__(self, user_id: int = 1):
        ...
        self.nocodb_client = NocoDBClient(NOCODB_BASE_URL, NOCODB_API_TOKEN)
