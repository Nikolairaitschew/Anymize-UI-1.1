...
def finetune_model(model, tokenizer, dataset, output_dir, progress=None):
    ...
    trainer = SFTTrainer(
        ...
        max_seq_length=2048,
        data_collator=None,  # Let SFTTrainer handle this
...
def create_ui():
    with gr.Blocks(title="Llama 3.2-3B Fine-tuning App") as app:
        ...
        with gr.Tab("Fine-tune Model"):
            ...
            gr.Markdown("*Select the model to fine-tune*")
            ...
            gr.Markdown("*Upload a dataset file in the same format as detector1.json*")
            ...
            gr.Markdown("*Directory to save the fine-tuned model*")
        ...
        with gr.Tab("Test Fine-tuned Model"):
            ...
            gr.Markdown("*Path to the fine-tuned model*")
        ...
        def finetune(model_name, file, epochs, lr, out_dir, progress=gr.Progress()):
            if file is None:
        ...
        train_btn.click(
            finetune,
            inputs=[model_name, dataset_file, epochs, learning_rate, output_dir],
